...
def run_timeloop(DIR, LAYER_DIR, layer = "pw"):
    ...
    if not debug_timeloop_output:
        p = subprocess.Popen(['timeloop-mapper', './../../accelerator/fusion/predictions/arch.yaml', './../../accelerator/fusion/predictions/components/smartbuffer_RF.yaml',
                              './../../accelerator/fusion/predictions/components/smartbuffer_SRAM.yaml',
        ...
        subprocess.run(['timeloop-mapper', './../../accelerator/fusion/predictions/arch.yaml', './../../accelerator/fusion/predictions/components/smartbuffer_RF.yaml',
                        './../../accelerator/fusion/predictions/components/smartbuffer_SRAM.yaml',\
                     mapper, LAYER_DIR+'prob/prob.yaml', LAYER_DIR+'constraints/constraints.yaml',\
                     '-o', LAYER_DIR+'output'])
