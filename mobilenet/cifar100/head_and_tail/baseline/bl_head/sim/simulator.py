...
def run_timeloop(DIR, LAYER_DIR, layer = "pw"):
    ...
    if not debug_timeloop_output:
        ...
        subprocess.run(['timeloop-mapper', './../../accelerator/baseline/arch.yaml', './../../accelerator/baseline/components/smartbuffer_RF.yaml', './../../accelerator/baseline/components/smartbuffer_SRAM.yaml',\
                     mapper, LAYER_DIR+'prob/prob.yaml', LAYER_DIR+'constraints/arch_constraints.yaml',\
