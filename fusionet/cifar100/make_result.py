...
network_head = {
  #'baseline' : "head_and_tail/baseline/bl_head/results/bl.csv",   #no baseline version for cifar100
...
network_tail = {
  #'baseline' : "head_and_tail/baseline/bl_tail/results/bl.csv",  no baseline version for Cifar100
...
col0 = head_fus["1_block"].tolist() + bn_names + tail_fus["1_block"].tolist()
