...
F_PEs = 64
X_PEs = 8
PRED_SPATIAL_GLB = {'decom':'N=1 R=1 S=1 P=1 Q=1 M=8 C=1', 'conv':'N=1 R=1 S=1 P=1 C=1 Q=1 M=8'}
...
F_BLOCKS = 16
F_GROUPS = 4
f_in_ch   = [32]*4 + [64]*4 + [96]*8
f_midd_ch = [2368]*8 + [3456]*8
f_out_ch = [32]*3 + [64]*4 + [96]*8 + [160]
f_pixels = [32]*3 + [16]*4 + [8]*9
f_stride = [1]*3 + [2] + [1]*3 + [2] + [1]*8
prune_factors = [0.014]*16


qtz_blocks = F_BLOCKS + 1
pred1_qtz = True
pred2_qtz = True
qtz = [4]*16   #[2]*8 + [4]*(qtz_blocks-4)
